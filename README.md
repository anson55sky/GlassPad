...
- **最新内测版 DMG：** [GlassPad v1.0.121](https://github.com/anson55sky/GlassPad-releases/releases/download/v1.0.121/GlassPad-1.0.121.dmg)
...
3. 如需**实时桌面壁纸**捕获：在 **系统设置 → 隐私与安全性 → 屏幕录制 / 辅助功能** 中授权 GlassPad，否则壁纸区域为空白占位。
