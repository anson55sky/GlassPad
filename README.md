...
- **最新内测版：v1.0.131** —— 请通过[官网报名](https://glasspad.pocketbay.app/)获取专属内测密钥与下载链接；本仓库已转为**私有**，Release 附件仅作版本存档，不作为公开下载入口。
...
- **内测分发版（1.0.131/）**：读取官网私有更新源 `glasspad.pocketbay.app/api/beta/update`，新版本推送不依赖本仓库。
- 也可在设置中手动「检查更新」。
