...
- **最新内测版：v1.0.147** —— 请前往[官网](https://glasspad.pocketbay.app/)**用邮箱注册并完成验证**后即可下载，无需任何激活码；本仓库为**公开引流页**，仅作版本标记与项目介绍；下载 / 更新统一走官网 glasspad.pocketbay.app，Release 不再附安装包。
- 所有版本见 [Releases](https://github.com/anson55sky/GlassPad/releases)
...
- **内测分发版（1.0.147）**：读取官网私有更新源 `glasspad.pocketbay.app/api/beta/update`，新版本推送不依赖本仓库。
- 也可在设置中手动「检查更新」。

## 许可与发布策略 / License & Distribution

- 当前为 **内测版（Open Beta）**，**全部功能免费，无需激活码**。
- 后续将进入「试用期 + 激活」阶段（详见源码库 README）。
- **源码**位于私有库 `anson55sky/GlassPad-releases`（不公开）；本仓库仅用于**版本存档**，下载与更新已收敛到实网。

## 反馈 / Feedback

- 内测用户：App 内 **设置 → 关于 → 提交反馈**（无需密钥）。
